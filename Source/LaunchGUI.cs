...
namespace KRASH
{
    ...
    public class LaunchGUI : MonoBehaviour
    {
...
#else
                cfgWindowRect = ClickThruBlocker.GUIWindow(0xB00B1E6, cfgWindowRect, drawCfgWindow, Localizer.GetStringByTag("#KRASH_ConfigWindow_title")); // "KRASH Config Window"
        ...
        public void drawCfgWindow(int id)
        {
            ...
            DrawTitle(Localizer.GetStringByTag("#KRASH_SelectedCFG")); //"Selected Cfg"
            GUILayout.Space(8);
            cfgExists = false;
            ...
            {
                GUILayout.Label(Localizer.GetStringByTag("#KRASH_NotCareer")); // "Configs don't apply to Sandbox or Science games"
            }
            GUILayout.EndHorizontal();
            GUILayout.EndArea();
            ...
            GUILayout.Space(5);
            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_ConfigName") + " "); // Config name: 
            ...
            if (strConfigName.Length > 0 && strConfigName[0] == '*')
            {
                ...
                GUILayout.Label(Localizer.GetStringByTag("#KRASH_ConfigNameNotGood"), lstyle); // "<-----> Must be renamed to save"
            }
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();
            ...
            if (GUILayout.Button(Localizer.GetStringByTag("#KRASH_Button_Save"), bstyle, GUILayout.Width(70))) // "Save"
            {
            ...
            if (HighLogic.CurrentGame.Mode == Game.Modes.CAREER)
            {
                if (GUILayout.Button(Localizer.GetStringByTag("#KRASH_Button_Accept"), bstyle, GUILayout.Width(70))) // "Accept"
                {
            ...
            if (GUILayout.Button(Localizer.GetStringByTag("#KRASH_Button_Reset"), bstyle, GUILayout.Width(70))) // "Reset"
            {
            ...
            if (GUILayout.Button(Localizer.GetStringByTag("#KRASH_Button_Cancel"), bstyle, GUILayout.Width(70))) // "Cancel"
            {
                configDisplayActive = !configDisplayActive;
            ...
            if (GUILayout.Button(Localizer.GetStringByTag("#KRASH_Button_Delete"), bstyle, GUILayout.Width(70))) // "Delete"
            {
            ...
            DrawTitle(Localizer.GetStringByTag("#KRASH_CostOptions")); // "Cost Options"

            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_FlatSetupCosts") + " "); // "Flat Setup Costs: "
            GUILayout.FlexibleSpace();
            strflatSetupCost = GUILayout.TextField(strflatSetupCost, GUILayout.MinWidth(50.0F), GUILayout.MaxWidth(50.0F));
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_FlatPer_minuteCosts") + " "); // "Flat Per-minute Costs: "
            GUILayout.FlexibleSpace();
            strflatPerMinCost = GUILayout.TextField(strflatPerMinCost, GUILayout.MinWidth(50.0F), GUILayout.MaxWidth(50.0F));
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_PerpartSetupCosts") + " "); // "Per-part Setup Costs: "
            GUILayout.FlexibleSpace();
            strperPartSetupCost = GUILayout.TextField(strperPartSetupCost, GUILayout.MinWidth(50.0F), GUILayout.MaxWidth(50.0F));
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_PerpartPerminuteCosts") + " "); // "Per-part Per-minute Costs: "
            GUILayout.FlexibleSpace();
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_PertonSetupCosts") + " "); // "Per-ton Setup Costs: "
            GUILayout.FlexibleSpace();
            strperTonSetupCost = GUILayout.TextField(strperTonSetupCost, GUILayout.MinWidth(50.0F), GUILayout.MaxWidth(50.0F));
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_PertonPerminuteCosts") + " "); // "Per-ton Per-minute Costs: "
            GUILayout.FlexibleSpace();
            strperTonPerMinCost = GUILayout.TextField(strperTonPerMinCost, GUILayout.MinWidth(50.0F), GUILayout.MaxWidth(50.0F));
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_PercentageSetupCosts") + " "); // "Percentage Setup Costs: "
            GUILayout.FlexibleSpace();
            strpercentSetupCost = GUILayout.TextField(strpercentSetupCost, GUILayout.MinWidth(50.0F), GUILayout.MaxWidth(50.0F));
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_PercentagePerminuteCosts") + " "); // "Percentage Per-minute Costs: "
            GUILayout.FlexibleSpace();
            strpercentPerMinCost = GUILayout.TextField(strpercentPerMinCost, GUILayout.MinWidth(50.0F), GUILayout.MaxWidth(50.0F));
            GUILayout.EndHorizontal(); ;

            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_AtmosphericMultiplier") + " "); // "Atmospheric Multiplier: "
            GUILayout.FlexibleSpace();
            ...
            DrawTitle(Localizer.GetStringByTag("#KRASH_TerminationOptions")); // "Termination Options (no data)"

            GUILayout.BeginHorizontal();
            bTerminateAtSoiWithoutData = GUILayout.Toggle(bTerminateAtSoiWithoutData, Localizer.GetStringByTag("#KRASH_TerminateatSoi")); // "Terminate at Soi"
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            bTerminateAtLandWithoutData = GUILayout.Toggle(bTerminateAtLandWithoutData, Localizer.GetStringByTag("#KRASH_TerminateatLand")); // "Terminate at Land"
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            bTerminateAtAtmoWithoutData = GUILayout.Toggle(bTerminateAtAtmoWithoutData, Localizer.GetStringByTag("#KRASH_TerminateatAtmo")); // "Terminate at Atmo"
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();

            GUILayout.Space(15);
            DrawTitle(Localizer.GetStringByTag("#KRASH_MiscellaneousOptionsGlobal")); // "Miscellaneous Options (global)"

            GUILayout.BeginHorizontal();
            bContinueIfNoCash = GUILayout.Toggle(bContinueIfNoCash, Localizer.GetStringByTag("#KRASH_Continuesimifnocash")); // "Continue sim if no cash"
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            bObeyPadLimits = GUILayout.Toggle(bObeyPadLimits, Localizer.GetStringByTag("#KRASH_Obeylaunchpadlimits")); // "Obey launch pad limits"
            GUILayout.FlexibleSpace();
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_DefaultMaxSimCost") + " "); // "Default Max Sim Cost: "
            GUILayout.FlexibleSpace();
            ...
            GUILayout.BeginHorizontal();
            bshowRunningSimCosts = GUILayout.Toggle(bshowRunningSimCosts, Localizer.GetStringByTag("#KRASH_ShowRunningSimCosts")); // "Show Running Sim Costs"
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            bshowAllInCareer = GUILayout.Toggle(bshowAllInCareer, Localizer.GetStringByTag("#KRASH_Showallbodiesincareer")); // "Show all bodies in career"
            ...
            {
                GUILayout.BeginHorizontal();
                GUILayout.Label(Localizer.GetStringByTag("#KRASH_HorizontalPosition") + " "); // "Horizontal Position: "
                GUILayout.FlexibleSpace();
                strhorizontalPos = GUILayout.TextField(strhorizontalPos, GUILayout.MinWidth(50.0F), GUILayout.MaxWidth(50.0F));
                GUILayout.EndHorizontal();

                GUILayout.BeginHorizontal();
                GUILayout.Label(Localizer.GetStringByTag("#KRASH_VerticalPosition") + " "); // "Vertical Position: "
                GUILayout.FlexibleSpace();
...
#else
                windowRect = ClickThruBlocker.GUIWindow(0xB00B1E6, windowRect, drawSelectorWindow, Localizer.GetStringByTag("#KRASH_LaunchSiteSelector_title")); // "Launch Site Selector"
#endif
            }
#if RP_1_131
        ...
        public void drawSelectorWindow(int id)
        {
            ...
            if (GUILayout.Button(Localizer.GetStringByTag("#KRASH_Button_OrbitSelection"))) // "Orbit selection"
            {
            ...
            if (GUILayout.Button(Localizer.GetStringByTag("#KRASH_Button_Landed"))) // "Landed"
            {
                selectType = SelectionType.celestialbodies;
            ...
            if (simType != SimType.LAUNCHPAD && simType != SimType.RUNWAY)
            {
                ...
                if (GUILayout.Button(Localizer.GetStringByTag("#KRASH_Button_All"), GUILayout.Width(45))) // "All"
                {
                    selectType = SelectionType.celestialbodies;
                ...
                if (GUILayout.Button(Localizer.GetStringByTag("#KRASH_Button_Planets"), GUILayout.Width(60))) // "Planets"
                {
                    bodiesList = getAllowableBodies(BodyTypeFilter.PLANETS);
                    selectType = SelectionType.celestialbodies;
                    //				sites = (editorType == SiteType.Any) ? LaunchSiteManager.getLaunchSites() : LaunchSiteManager.getLaunchSites(editorType, true, "RocketPad");
                }
                if (GUILayout.Button(Localizer.GetStringByTag("#KRASH_Button_Moons"), GUILayout.Width(60))) // "Moons"
                {
        ...
        void drawRightSelectorWindow(SelectionType type)
        {
            ...
            //if (HighLogic.CurrentGame.Mode == Game.Modes.CAREER)
            {
                ...
                if (HighLogic.CurrentGame.Mode == Game.Modes.CAREER)
                {
                        ...
                        !KRASHShelter.persistent.shelterSimulationActive))
                    {
                        ...
                        startSim += "\n" + Localizer.GetStringByTag("#KRASH_SimulateInfo_NoFundsToSim"); // "\nNot enough money to start sim"
                        flyable = false;
                    }
                }
                ...
                if (lockedparts)
                {
                    startSim += "\n" + Localizer.GetStringByTag("#KRASH_SimulateInfo_LockedParts"); // "\nVessel has locked parts"
                    flyable = false;
                ...
                if (!controllable)
                {
                    startSim += "\n" + Localizer.GetStringByTag("#KRASH_SimulateInfo_VesselNotControllable"); // "\nVessel is not controllable"
                    flyable = false;
                }
                ...
                if (HighLogic.CurrentGame.Mode == Game.Modes.CAREER)
                    ...
                    {
                        startSim += "\n" + Localizer.GetStringByTag("#KRASH_SimulateInfo_SimCostexceedslimit"); // "\nSim cost exceeds limit"
                        flyable = false;
                    }
            }
            ...
            if (flyable)
            {
                startSim = Localizer.GetStringByTag("#KRASH_Button_StartSimulation"); // "Start simulation"

                if (GUILayout.Button(Localizer.GetStringByTag("#KRASH_Button_StartSimulation"), bstyle, GUILayout.Width(170.0f), GUILayout.Height(125.0f))) // "Start simulation"
                {
            ...
            else
            {
                ...
                GUILayout.Label(Localizer.GetStringByTag("#KRASH_VesselUnlaunchableReasons")); //"Vessel Unlaunchable for following reason(s):"
                GUILayout.EndHorizontal();
                GUILayout.BeginHorizontal();
            ...
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_SimulationSettings"), fontColorCyan); //"Simulation Settings"
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_StartLocation")); // "Start location:"
            GUILayout.EndHorizontal();
            GUILayout.BeginHorizontal();
            switch (type)
            {
                case SelectionType.launchsites:
                    ...
                    switch (simType)
                    {
                        case SimType.LAUNCHPAD:
                            GUILayout.Box(Localizer.GetStringByTag("#KRASH_Launchpad")); // "Launchpad"
                            break;
                        case SimType.RUNWAY:
                            GUILayout.Box(Localizer.GetStringByTag("#KRASH_Runway")); // "Runway"
                            break;
                    }
                    GUILayout.EndHorizontal();
                    break;
                case SelectionType.celestialbodies:
                    if (selectedBody != null)
                    {
                        ...
                        GUILayout.BeginHorizontal();
                        GUILayout.Label(Localizer.GetStringByTag("#KRASH_Altitude")); // "Altitude:"
                        GUILayout.FlexibleSpace();
                        ...
                        {
                            GUILayout.BeginHorizontal();
                            GUILayout.Label(Localizer.GetStringByTag("#KRASH_Latitude")); // "Latitude:"
                            GUILayout.FlexibleSpace();
                            ...
                            GUILayout.BeginHorizontal();
                            GUILayout.Label(Localizer.GetStringByTag("#KRASH_Longitude")); //"Longitude:"
                            GUILayout.FlexibleSpace();
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_PartCount")); // "Part count:"
            GUILayout.FlexibleSpace();
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_DryMass")); // "Dry Mass:"
            GUILayout.FlexibleSpace();
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_FuelMass")); // "Fuel Mass:"
            GUILayout.FlexibleSpace();
            GUILayout.Label(fuelMass.ToString(), fontColorYellow);
            GUILayout.EndHorizontal();

            GUILayout.BeginHorizontal();
            GUILayout.Label(Localizer.GetStringByTag("#KRASH_TotalMass")); // "Total Mass:"
            GUILayout.FlexibleSpace();
            ...
            {
                GUILayout.BeginHorizontal();
                KRASHShelter.instance.disableTestFlightForSim = GUILayout.Toggle(KRASHShelter.instance.disableTestFlightForSim, KRASH.testFlightLoaded ? Localizer.GetStringByTag("#KRASH_Button_DisableTestFlight") : Localizer.GetStringByTag("#KRASH_Button_DisableTestLite")); // "Disable TestFlight""Disable TestLite"
                GUILayout.FlexibleSpace();
                GUILayout.EndHorizontal();
            }
            ...
            if (HighLogic.CurrentGame.Mode == Game.Modes.CAREER)
            {
                ...
                GUILayout.BeginHorizontal();
                GUILayout.Label(Localizer.GetStringByTag("#KRASH_SimulationCosts"), fontColorCyan); // "Simulation Costs:"
                GUILayout.EndHorizontal();

                GUILayout.BeginHorizontal();
                GUILayout.Label(Localizer.GetStringByTag("#KRASH_SimSetupCost")); // "Sim setup cost:"
                GUILayout.FlexibleSpace();
                ...
                GUILayout.BeginHorizontal();
                GUILayout.Label(Localizer.GetStringByTag("#KRASH_EstSimMinCost")); // "Est. Sim/min cost:"
                GUILayout.FlexibleSpace();
                ...
                if (m > 1.0)
                {
                    ...
                    GUILayout.Label(Localizer.GetStringByTag("#KRASH_EstAtmoSimMinCost")); // "Est. Atmo Sim/min cost:"
                    GUILayout.FlexibleSpace();
                ...
                GUILayout.BeginHorizontal();
                limitMaxCosts = GUILayout.Toggle(limitMaxCosts, Localizer.GetStringByTag("#KRASH_LimitMaxCosts")); // "Limit max costs"
                GUILayout.FlexibleSpace();
                GUILayout.EndHorizontal();
                if (limitMaxCosts)
                {
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.Label(Localizer.GetStringByTag("#KRASH_Limit") + " "); // "Limit: "
                    GUILayout.FlexibleSpace();
                    double f;
            ...
            if (GUILayout.Button(Localizer.GetStringByTag("#KRASH_Button_Cancel"), bstyle, GUILayout.Width(170.0f), GUILayout.Height(30.0f))) // "Cancel"
            {
                GUI.backgroundColor = oldColor;
                GUIToggle();
                return;
